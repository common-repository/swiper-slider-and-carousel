...
<div class="wrap">
	...
	<h2><?php _e( 'Swiper Slider and Carousel - Features', 'swiper-slider-and-carousel' ); ?></h2><br />	

	<p class="custom-note">Important Recommendations : For better user experience we have shifted  <strong>Swiper Slider and Carousel</strong> plugin in our to new plugin ie <a href="https://wordpress.org/plugins/sliderspack-all-in-one-image-sliders/" style="color:#fff;" target="_blank"><strong>SlidersPack – All In One Image/Post Slider</strong></a>. It help us to maintain our all slider plugins in a single plugin package and provide you better and fast support.</p>
