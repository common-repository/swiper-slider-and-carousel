...
<div class="wrap">
	...
	<h2><?php _e( 'Hire Us - Get unlimited expert WordPress Support and Development', 'swiper-slider-and-carousel' ); ?></h2><br />

	<div class="support-data">
	<h3 style="margin-bottom:5px;"><?php _e( 'Highlight of Hiring:', 'swiper-slider-and-carousel' ); ?></h3>
		<ul>
